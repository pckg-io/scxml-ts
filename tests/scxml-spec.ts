...
import { ScxmlDoc, ScxmlStructureVisitor, ScxmlState, ScxmlParallel, ScxmlFinal, ScxmlHistory, ScxmlTransition } from '../src/scxml';
...
describe('SCXML Types and Visitor Tests', () => {
  ...
  describe('SCXMLVisitor Integration', () => {
    it('should parse minimal SCXML and create valid ScxmlDoc', () => {
      ...
      const visitor = new ScxmlStructureVisitor(parsed);
